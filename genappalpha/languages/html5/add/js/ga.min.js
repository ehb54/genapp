...
":"+b+":last_value",[[]]);ga.value.clear.plot2d(b);c.plot([[]],ga.value.get.plot2d.plot_options(b));break;case "video":c.html("");break;case "atomicstructure":b.replace(/^#/,"");$("#global_data").data(a+":"+b+":last_value","");$(b).html("");break;default:c.val(c.attr("value"))}ga.value.saveLastValue(a,b);$(b+"_msg").html("")};
...
k+":#"+b+":last_value";z=m.file?m.file:m;_jmol_info[b].script="set background ["+ga.colors.background+"]; set zoomlarge false;set echo top center;echo loading "+z.split("/").pop()+';refresh;load "'+z+'";';ga.set(a+":jsmoladd")&&(_jmol_info[b].script+=ga.set(a+":jsmoladd"));m.script&&(_jmol_info[b].script+=";"+m.script);$("#global_data").data(t,_jmol_info[b].script);$("#"+b).html(Jmol.getAppletHtml("jmolApplet"+b,_jmol_info[b]));break;case "checkbox":case "radio":q.prop("checked",!0);break;case "div":q.html(m);
break;case "video":x=$("#"+b),r="<video ",x.attr("data-width")&&(r+=' width="'+x.attr("data-width")+'"'),x.attr("data-height")&&(r+=' height="'+x.attr("data-height")+'"'),r+=" controls>",r+='<source src="'+m+'.mp4" type="video/mp4" /><source src="'+m+'.webm" type="video/webm" />',r+="</video>",x.html(r);case "filelink":u='<a href="'+m+'" target="_blank">'+m.split("/").pop()+"</a>";t=k+":#"+b+":last_value";$("#global_data").data(t,u);$("#"+b+"_filelink").html(u);break;case "filelinkm":t=k+":#"+b+":last_value";
u="";$.each(m,function(a,b){u+='<a href="'+b+'" target="_blank">'+b.split("/").pop()+"</a> "});$("#global_data").data(t,u);$("#"+b+"_filelink").html(u);break;default:$("#global_data").data("_append:"+k+"_"+b)?(q.val(q.val()+"\n"+m),q.height(parseFloat(q.prop("scrollHeight")+parseFloat(q.css("borderTopWidth"))+parseFloat(q.css("borderBottomWidth"))))):q.val(m)}else c?"_"==b.charAt(0)?/^_fs_/.test(b)&&ga.data.nofcrefresh[a]||("_message"==b&&messagebox(m),/^_getinput/.test(b)&&"_getinput"==b&&ga.valuen.input(a,
m),"_textarea"==b&&ga.data.textarea(p,m),"_airavata"==b&&ga.data.airavata(p,m),"_status"==b&&"complete"==m&&c(d,0,0)):(f||(v.append("<p>Unexpected results:</p>"),f=1),v.append("<p>"+b+" => "+m+"</p>")):"_"==b.charAt(0)?/^_fs_/.test(b)&&ga.data.nofcrefresh[a]||($("#_state").data(b,m),g=1,"_status"==b&&(A.job_status=m),/^_getinput/.test(b)&&"_getinput"==b&&ga.valuen.input(a,m),"_textarea"==b&&ga.data.textarea(p,m),"_airavata"==b&&ga.data.airavata(p,m)):"-close"==b?h=1:"-close2"==b?n=1:(f||(v.text(""),
v.append("<p>Unexpected results:</p>"),e=f=1),v.append("<p>"+b+" => "+m+"</p>"))});ga.value.saveLastValues(k);ga.value.saveLastValue(k,w);$(p+"_progress").html("");g&&syncState();h&&closeModal();n&&closeModal2();return A};
