...
like( $ui2_js, qr/function renderNglSelectionInspector\(output, component, structurePayload\).*?setBaseVisibility\(mode === "whole"\).*?component\.addRepresentation/s, 'selection visibility preserves the whole structure by default and draws declared subsets locally' );
