...
like( $ui2_react_source, qr/<aside className="ui2-workbench-input-pane" hidden=\{inputRailCollapsed \|\| workspaceExpanded\}>.*?<div className="ui2-workbench-input-scroll" hidden=\{Boolean\(submitted\) && !inputEditOpen\}>/s, 'workbench keeps the complete input form mounted while the submitted summary is shown' );
