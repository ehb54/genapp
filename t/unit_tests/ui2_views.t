...
like( $ui2_js, qr/function attachNglFileTrajectory\(.*?window\.NGL\?\.autoLoad.*?nglTrajectoryParameters\(.*?component\.addTrajectory\(frames, trajectoryParams\)/s, 'ui2 NGL viewer parses a file trajectory before attaching it to the loaded structure' );
