...
like( $ui2_react_css, qr/\.ui2-repeat-compact \.ui2-repeated-coupled-choice-cards\{(?=[^}]*display:grid)(?=[^}]*grid-template-columns:minmax\(0,1fr\))(?=[^}]*min-width:0)[^}]*\}/, 'compact coupled choices stack visibly inside their table cell' );
