...
like( $ui2_js, qr/function applyNglParsedPdbCoordinates\(component, loaded\).*?loaded\?\.frames.*?topologyAtomCount.*?structure\.updatePosition.*?structure\.refreshPosition.*?updateRepresentations/s, 'PSF-backed components validate and apply matching PDB coordinates directly' );
