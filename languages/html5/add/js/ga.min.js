...
ga.layout.process=function(a){if(a&&a.resource)if(ga.layout.module&&ga.layout.module.name){var b=ga.layout.module.name;ga.layout.fields.b_submit||(ga.layout.fields.b_submit={},ga.layout.fields.b_submit.lhtml='<label class=""></label>',ga.layout.fields.b_submit.dhtml='<button id="'+b+'_b_submit_button"><span class="buttontext">Submit</span></button><div id="b_submit_buttonval"></div>');ga.layout.fields.b_submit.eval='\n$( "#'+b+'_b_submit_button" ).click( function( e ) {\n    console.log("b_submit");\n   e.preventDefault();\n   e.returnValue = false;\n   $( "#'+
b+'" ).find( ".toclear" ).remove();   \n   if ( '+b+'_timeout_handler != "unset" ) {\n       \n       clearTimeout( '+b+"_timeout_handler );\n       if ( "+b+"_timeout_handler_uuid ) {\n           ga.ws.unsub( "+b+'_timeout_handler_uuid, "'+b+'" );\n       }\n       '+b+'_timeout_handler = "unset";\n   }\n   ga.value.resetDefaultValues( "'+b+'_output", true );\n';ga.layout.fields.b_submit.eval=a&&a.captcha?ga.layout.fields.b_submit.eval+("\n   ga.captcha( do_"+b+"_submit, $(this) );\n   return false;\n"):
ga.layout.fields.b_submit.eval+('\n   return ga.xsede.select( "'+a.resource+'", do_'+b+"_submit, $(this) );\n");ga.layout.fields.b_submit.eval+="\n});\n";ga.layout.fields.b_reset||(ga.layout.fields.b_reset={},ga.layout.fields.b_reset.lhtml='<label class=""></label>',ga.layout.fields.b_reset.lhtml+="",ga.layout.fields.b_reset.dhtml='<button id="'+b+'_b_reset_button"><span class="buttontext">Reset</span></button><div id="b_reset_buttonval"></div>',ga.layout.fields.b_reset.dhtml+="");ga.layout.fields.b_reset.eval=
'\n$("#'+b+'_b_reset_button" ).click(function(){\n    console.log("b_reset");\n    return '+b+"_reset();\n});";ga.layout.fields[b+"_progress"]||(ga.layout.fields[b+"_progress"]={},ga.layout.fields[b+"_progress"].lhtml="",ga.layout.fields[b+"_progress"].dhtml='<span id="'+b+'_progress"></span>',ga.layout.fields[b+"_progress"].eval="");ga.layout.fields[b+"_output_airavata"]||(ga.layout.fields[b+"_output_airavata"]={},ga.layout.fields[b+"_output_airavata"].lhtml="",ga.layout.fields[b+"_output_airavata"].dhtml=
'<span id="'+b+'_output_airavata"></span>',ga.layout.fields[b+"_output_airavata"].eval="");ga.layout.fields[b+"_output_msgs"]||(ga.layout.fields[b+"_output_msgs"]={},ga.layout.fields[b+"_output_msgs"].lhtml="",ga.layout.fields[b+"_output_msgs"].dhtml='<div id="'+b+'_output_msgs" class="warning" type="msgs"></div>',ga.layout.fields[b+"_output_msgs"].eval="");ga.layout.fields[b+"_output_textarea"]||(ga.layout.fields[b+"_output_textarea"]={},ga.layout.fields[b+"_output_textarea"].lhtml="",ga.layout.fields[b+
"_output_textarea"].dhtml='<textarea readonly hidden id="'+b+'_output_textarea"></textarea>',ga.layout.fields[b+"_output_textarea"].eval="");ga.layout.panel.panels?ga.layout.setup():console.error("error JSON contains no panels")}else console.error("ga.layout.process() required ga.layout.module.name set");else console.error("ga.layout.process() required defaults object argument not specified")};
