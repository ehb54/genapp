...
ga.progress = function( mod, val, valmax ) {
  console.log( `ga.progress( ${mod}, ${val}, ${valmax} )` );
  if ( !$(`#${mod}_progress`).html().length ) {
     ga.progress.set( mod );
  }
  console.log( 'ga.progress() html is now: ' +  $(`#${mod}_progress`).html() );
...
ga.progress.set = function( mod, prefix ) {
  ...
  console.log( 'ga.progress.set() html is now: ' +  $(`#${mod}_progress`).html() );
}

ga.progress.clear = function( mod, msg ) {
  console.log( `ga.progress.clear( ${mod} ) ${msg}` );
  $(`#${mod}_progress`).empty();
}  
            ...
            if ( msging_f ) {
                if ( k.charAt( 0 ) == "_" ) {
                    if ( !/^_fs_/.test( k ) || !ga.data.nofcrefresh[ mod ] ) {
                        ...
                        if ( k == "_progress" )
                        { 
                            console.log( "ga.data.update() _progress is now " + v );
                            ga.progress( mod, v );
                        }
                    }
                } else {
