...
f.label+"</label>");c+="</td>";f.size&&1<f.size&&(c+="</tr><tr>");c+='<td><select id="'+f.id+'"';f.fontfamily&&(c+=' style="font-family: '+f.fontfamily+';"');f.size&&(c+=" size="+f.size);c+=">";if(!f.values){g+="No values for listbox "+f.id+". ";break}for(e=0;e<f.values.length;++e)c+='<option value="'+e+'">'+f.values[e].replace(/ /g,"&nbsp")+"</option>";c+="</select></td></tr>";break;default:g+="Unknown or currently unsupported field:type "+f.type+". "}c+="</table></form>";if(b._question.buttons&&
