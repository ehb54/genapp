...
h+'">'+e.resources[h][m]+"</label></td></tr>";messagebox({icon:"question.png",text:f+"</table>",buttons:g});return"deferred";default:return messagebox({icon:"toast.png",text:"ga.airavata.select, unknown selectoin type '"+a+"'"}),"abort"}};ga.value={};ga.value.settings={};
...
k+":#"+b+":last_value";z=l.file?l.file:l;_jmol_info[b].script="set background ["+ga.colors.background+"]; set zoomlarge false;set echo top center;echo loading "+z.split("/").pop()+';refresh;load "'+z+'";';ga.set(a+":jsmoladd")&&(_jmol_info[b].script+=ga.set(a+":jsmoladd"));l.script&&(_jmol_info[b].script+=";"+l.script);$("#global_data").data(r,_jmol_info[b].script);$("#"+b).html(Jmol.getAppletHtml("jmolApplet"+b,_jmol_info[b]));break;case "checkbox":case "radio":p.prop("checked",!0);break;case "div":p.html(l);
break;case "video":w=$("#"+b),q="<video ",w.attr("data-width")&&(q+=' width="'+w.attr("data-width")+'"'),w.attr("data-height")&&(q+=' height="'+w.attr("data-height")+'"'),q+=" controls>",q+='<source src="'+l+'.mp4" type="video/mp4" /><source src="'+l+'.webm" type="video/webm" />',q+="</video>",w.html(q);case "filelink":t='<a href="'+l+'" target="_blank">'+l.split("/").pop()+"</a>";r=k+":#"+b+":last_value";$("#global_data").data(r,t);$("#"+b+"_filelink").html(t);break;case "filelinkm":r=k+":#"+b+":last_value";
t="";$.each(l,function(a,b){t+='<a href="'+b+'" target="_blank">'+b.split("/").pop()+"</a> "});$("#global_data").data(r,t);$("#"+b+"_filelink").html(t);break;default:$("#global_data").data("_append:"+k+"_"+b)?(p.val(p.val()+"\n"+l),p.height(parseFloat(p.prop("scrollHeight")+parseFloat(p.css("borderTopWidth"))+parseFloat(p.css("borderBottomWidth"))))):p.val(l)}else c?"_"==b.charAt(0)?/^_fs_/.test(b)&&ga.data.nofcrefresh[a]||("_message"==b&&messagebox(l),/^_getinput/.test(b)&&"_getinput"==b&&ga.valuen.input(a,
l),"_textarea"==b&&ga.data.textarea(n,l),"_airavata"==b&&ga.data.airavata(n,l),"_status"==b&&"complete"==l&&c(d,0,0)):(f||(u.append("<p>Unexpected results:</p>"),f=1),u.append("<p>"+b+" => "+l+"</p>")):"_"==b.charAt(0)?/^_fs_/.test(b)&&ga.data.nofcrefresh[a]||($("#_state").data(b,l),g=1,"_status"==b&&(x.job_status=l),/^_getinput/.test(b)&&"_getinput"==b&&ga.valuen.input(a,l),"_textarea"==b&&ga.data.textarea(n,l),"_airavata"==b&&ga.data.airavata(n,l)):"-close"==b?h=1:"-close2"==b?m=1:(f||(u.text(""),
u.append("<p>Unexpected results:</p>"),e=f=1),u.append("<p>"+b+" => "+l+"</p>"))});ga.value.saveLastValues(k);ga.value.saveLastValue(k,v);$(n+"_progress").html("");g&&syncState();h&&closeModal();m&&closeModal2();return x};
