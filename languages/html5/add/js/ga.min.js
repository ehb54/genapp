var ga={tmp:{},multistage:{},fielderrors:0};
...
b[0],b.splice(0,b.length),b.push(parseInt(parseFloat(c)+.5))):$(a+"_msg").html(""));return!0};ga.value.sethiddenfields=function(a,b){var c=[],d;$.each(a,function(a,b){$.each(b,function(a,b){c.push(b)})});c=ga.repeat.map.convert(c);for(d=0;d<c.length;d++)$("#"+c[d]).data("repeater")&&$("#"+c[d]+"-repeater").hide(),$("#"+c[d]+", label[for="+c[d]+"]").hide()};
