...
# $phpdir = "__docroot:html5__/__application__";
$phpdir = "/var/www/html/cgrun";


require_once "genapp.php";
require_once "$phpdir/ajax/ga_filter.php";
...
require_once "$phpdir/ajax/joblog.php";
