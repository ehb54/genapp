...
{
   setCaption( "__title__ __version__" );
   ...
   //   palette_pb_hover.setColor( QColorGroup::Foreground, QColor( __select_color_rgb__ ) );
   ...
   palette_pb_hover.setColor( QColorGroup::Button, QColor( __button_hover_g_color_rgb__ ) );

   palette_lbl_hover = palette_app;
   palette_lbl_hover.setColor( QColorGroup::Foreground, QColor( __select_color_rgb__ ) );
